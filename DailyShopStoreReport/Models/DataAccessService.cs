...
{
    public class DataAccessService : IData 
    {
        private readonly ApplicationDbContext _context;

        public DataDictionary Data { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
        ...
        //    var data = await (from menu in _context.AppRole
        //                      where roleIds.Contains(menu.Id)
        //                      select menu)
