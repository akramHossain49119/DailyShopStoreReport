        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppMenuId = table.Column<Guid>(nullable: true),
                    AppMenusAMId = table.Column<int>(nullable: true),
                    ControllerName = table.Column<string>(nullable: true),
                    ActionName = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppMenus", x => x.AMId);
                    table.ForeignKey(
                        name: "FK_AppMenus_AppMenus_AppMenusAMId",
                        column: x => x.AppMenusAMId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    YrId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    YearName = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SelectYears", x => x.YrId);
                });

            migrationBuilder.CreateTable(
                name: "YearlyDataModelViews",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_YearlyDataModelViews", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppPermissions", x => x.ApId);
                    table.ForeignKey(
                        name: "FK_AppPermissions_AppMenus_AppMenusAMId",
                        column: x => x.AppMenusAMId,
                        principalTable: "AppMenus",
                        principalColumn: "AMId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppMenus_AppMenusAMId",
                table: "AppMenus",
                column: "AppMenusAMId");

            migrationBuilder.CreateIndex(
                name: "IX_AppPermissions_AppMenusAMId",
